  ...
  stages {
    ...
    stage('Deploy') {
      environment {
        ...
        HELM_GIT_REPO_URL = "github.com/joymondal/rsvpapp-helm-cicd.git"
        GIT_REPO_EMAIL = 'joy.mondal@gmail.com'
        ...
        container('tools') {
          ...
          dir("rsvpapp-helm-cicd") {
            ...
            sh '''#!/bin/bash
              ...
              git push https://$GIT_CREDS_USR:$GIT_CREDS_PSW@github.com/$GIT_CREDS_USR/rsvpapp-helm-cicd
